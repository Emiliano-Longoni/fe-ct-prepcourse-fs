...
function diaDeLaSemana(numeroDeDia) {
   ...
   if (numeroDeDia < 1 || numeroDeDia > 7){
      return "Dato no valido, por favor elija una opcion entre 1 y 7"
   } if (numeroDeDia == 1 || numeroDeDia == 7){
...
function breakStatement(num) {
   ...
   // Tu código:function breakStatement(num) {
  var bucle = [];
  for (var i = 0; i < 10; i++) {
    num = num + 2;
    if (num === i) break;
